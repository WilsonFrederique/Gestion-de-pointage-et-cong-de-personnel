...
@section('title', "LISTE DES EMPLOYÉS ABSENCE")
        ...
        <div class="clearfix mb-4">
            <div class="d-flex justify-content-between align-items-center gap-50">
                <div class="custom-btn-group">
                    ...
                    <h1 class="custom-h1-presence">LISTE DES ABSENCES</h1>

                </div>
                <div class="btn-group">
                    <a class="btn btn-primary custom-background-presence" href="{{ route('admin.pointages_presences') }}">PRÉSENCE</a>
                </div>
            </div>
        </div>
